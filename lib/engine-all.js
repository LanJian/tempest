...
(function() {
  ...
  window.Component = (function() {
    ...
    Component.prototype.removeListener = function(listenerToRemove) {
      return this.listenersToRemove.push(listenerToRemove);
    };
    ...
    Component.prototype.handle = function(evt) {
      var child, i, isHandled, listener, _i, _j, _len, _ref, _ref1;
    ...
    Component.prototype.update = function(dt) {
      var child, k, l, t, toRemove, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _results;
...
(function() {
  ...
  window.Sprite = (function(_super) {
    ...
    Sprite.prototype.onSpriteImageLoaded = function(evt) {
      var f, h, key, spr, w, _i, _len, _ref, _ref1;
      if (!(this.hasSpriteSheet(evt.target))) {
        return;
      }
      if (this.size.w !== 0 || this.size.h !== 0) {
        return;
    ...
    Sprite.prototype.hasSpriteSheet = function(ss) {
      var key, val, _ref;
      _ref = this.spriteSheets;
      for (key in _ref) {
        val = _ref[key];
    ...
    Sprite.prototype.update = function(dt) {
      ...
      if (spriteSheet && this.isPlaying && spriteSheet.loaded) {
        ...
        if (this.curInterval >= anim.frameInterval) {
          this.frameIndex++;
          if ((this.frameIndex >= anim.startFrame + anim.duration) && !this.loop) {
            this.stop();
          }
...
(function() {
  ...
  window.SpriteImage = (function(_super) {
    ...
    SpriteImage.prototype.hasSpriteSheet = function(ss) {
      return this.spriteSheet === ss;
    };

    SpriteImage.prototype.onSpriteImageLoaded = function(evt) {
      var f;
      if (this.spriteSheet !== evt.target) {
        return;
      }
      this.loaded = true;
      if (this.size.w !== 0 || this.size.h !== 0) {
...
(function() {
  ...
  window.Coffee2D.Text = (function(_super) {

    __extends(Text, _super);

    function Text(text, color, style) {
      this.text = text;
      this.color = color != null ? color : 'black';
      this.style = style != null ? style : '12px Arial';
      Text.__super__.constructor.call(this);
    }

    Text.prototype.draw = function(ctx) {
      Text.__super__.draw.call(this, ctx);
      ctx.font = this.style;
      ctx.fillStyle = this.color;
      return ctx.fillText(this.text, this.position.x, this.position.y);
    };
  ...
  window.Tween = (function() {
    ...
    Tween.prototype.init = function() {
      ...
      for (k in _ref) {
        v = _ref[k];
        this.initialProps[k] = {};
        _results.push($.extend(this.initialProps[k], this.obj[k]));
      }
      return _results;
    };

    Tween.prototype.onComplete = function(func) {
      return this.onCompleteFunc = func;
    };
    ...
    Tween.prototype.update = function(dt) {
      ...
      if (this.curTime > this.duration) {
        ...
        this.updateProps(this.obj, this.props, this.initialProps);
        this.finished = true;
      } else {
        this.updateProps(this.obj, this.props, this.initialProps);
      }
    ...
    Tween.prototype.updateProps = function(obj, props, initProps) {
      var initialValue, k, ratio, v, _results;
      _results = [];
      for (k in props) {
        v = props[k];
        ratio = this.curTime * 1.0 / this.duration;
        if ($.isNumeric(v)) {
          initialValue = initProps[k];
          _results.push(obj[k] = initialValue + ratio * (v - initialValue));
        } else {
          _results.push(this.updateProps(obj[k], props[k], initProps[k]));
        }
      }
      return _results;
    };
...
(function() {
  ...
  window.IsometricMap = (function(_super) {
    ...
    IsometricMap.prototype.addObject = function(obj, i, j) {
      ...
      obj.setPosition(x, y);
      return this.objLayer.push(obj);
    };

    IsometricMap.prototype.update = function(dt) {
      var child, k, obj, t, toRemove, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _results;
      _ref = this.keyDownHandlers;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i];
        if (Event.isKeyDown(k.which)) {
...
(function() {
  ...
  window.Tile = (function(_super) {
    ...
    Tile.prototype.setup = function() {
      this.children.splice(1, 0, this.boundingPolygon);
